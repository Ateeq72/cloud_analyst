...
public class SimulationPanel extends JPanel implements CloudSimEventListener {
	...
	public SimulationPanel(){
		...
		InputStream mapFile1 = getClass().getClassLoader().getResourceAsStream("resources/map1.png");
		InputStream mapFile2 = getClass().getClassLoader().getResourceAsStream("resources/map2.png");
